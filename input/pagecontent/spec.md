...
<p>Diese ungewöhliche Definition für "Alter" ist an dieser Stelle absichtlich so gewählt worden. Im Allgemeinen geht man in der medizinischen Forschung oder Gesundheitsversorgung davon aus, dass es sich um das Alter einer Person handelt. Jedoch wird dieser Kontext implizit angenommen und ist insbesondere für die computergestützte Verarbeitung nicht trivial. Des Weiteren ist auch der Bezugszeitpunkt für die Interpretation des enthaltenen Wertes von entscheidender Bedeutung.</p>
