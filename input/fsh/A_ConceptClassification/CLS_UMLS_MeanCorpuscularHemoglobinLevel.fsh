Profile: CLS_UMLS_MeanCorpuscularHemoglobinLevel
Parent: Observation
Id: cls-umls-mean-corpuscular-hemoglobin-level
Title: "CLS UMLS Mean Corpuscular Hemoglobin Level"
Description: "Dieses abstrakte Profil beschreibt die Kategorie 'Mittleres korpuskuläres Hämoglobin Level'."
* ^status = #draft
* ^abstract = true
// Hierarchy and Classification
* insert RS_ObservationCategorySlicingRules
* insert RS_CreateOneFurtherCategory(ErythrocyteMeanCorpuscularHemoglobin, $UMLS, C0945625)
