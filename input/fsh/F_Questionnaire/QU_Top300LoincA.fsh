...
* item.item[=].item[=].text.extension.url = "lang"
* item.item[=].item[=].text.extension.valueString = "en"
...
* item.item[=].item[=].item[=].text.extension.url = "lang"
* item.item[=].item[=].item[=].text.extension.valueString = "en"
