Profile: CDE_CreatinineInSerumOrPlasma
Parent: Observation
Id: cde-creatinine-in-ser-or-plas
Title: "CDE Creatinine In Serum Or Plasma"
Description: "Dieses CDE enthält den Messparameter 'Kreatinin in Serum oder Plasma'."
